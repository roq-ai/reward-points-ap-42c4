...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  ...
  'inventory.update': { roles: ['tenant-roles'], key: 'inventoryId', tenantPath: [], userPath: [] },
  'issue.create': { roles: ['tenant-roles', 'tenant-owner-roles'], key: 'issueId', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['no-role'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['no-role'];
