...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Reward Points app`}</title>

        <meta
          name="description"
          content="Reward Points App: Streamlining your rewards management with ease. From registration to tracking transactions, managing cards, and updating profiles. Tailored for owners, renters, and students. Your ultimate partner for reward points system."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1558459654-c430be5b0a44?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxyZXdhcmQlMjBwb2ludHN8ZW58MHx8fHwxNjk1Mjk1MDg2fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Reward Points App: Streamlining your rewards management with ease. From registration to tracking transactions, managing cards, and updating profiles. Tailored for owners, renters, and students. Your ultimate partner for reward points system.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="No Role" type="no-role" abilities={appConfig.ownerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
