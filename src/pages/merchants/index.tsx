...
export function MerchantListPage(props: MerchantListPageProps) {
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'merchant_address', header: 'Merchant Address', accessorKey: 'merchant_address' },
  ...
  return (
    <Flex direction="column" gap={{ md: 6, base: 7 }} shadow="none">
      <Flex justifyContent={{ md: 'space-between' }} direction={{ base: 'column', md: 'row' }} gap={{ base: '28px' }}>
        ...
        {hasAccess('merchant', AccessOperationEnum.CREATE, AccessServiceEnum.PROJECT) && (
          <NextLink href={`/merchants/create`} passHref legacyBehavior>
            <Button
              onClick={(e) => e.stopPropagation()}
              height={'2rem'}
